  ...
  >
    <div class="c-landing__header">
      <nuxt-link to="/profile">
        <AnimatedLink class="c-bezier"> Profile </AnimatedLink>
      </nuxt-link>
      ...
      <div class="c-intro">
        <div class="c-intro__image c-name__image ov-h">
          <div
            class="inner"
            style="
              background-image: url('/images/munachi/PHOTO-2025-11-16-20-41-59.jpg');
            "
          ></div>
        </div>
        ...
        <div class="c-intro__details">
          <h1 class="details-title span-overflow" style="margin-bottom: 12px">
            <span class="ov-inner"> munchi </span>
          </h1>
      ...
      <div class="c-jobs">
        <div class="c-desc">
          <p class="span-overflow">
            <span class="ov-inner">
              Creating exceptional culinary experiences with a focus on quality
        ...
        <div class="c-job">
          ...
          >
            <h2 class="c-job__title align-right ml-auto">
              <span>CUL<span class="fraunces">I</span>NARY</span>
              <br />
          ...
          <div class="c-job__video">
            <video
              :src="
                optImg(
                  'https://res.cloudinary.com/dnf1unqkp/video/upload/v1763468507/IMG_0996_q9lzfh.mp4'
                )
              "
        ...
        <div class="c-job">
            ...
            <a href="https://www.instagram.com/korty_eo/">
              ...
              <span class="align-right bottom-text">
                ...
                <div class="title-desc ml-auto">
                  <p>
                    these showcase my culinary journey and creations. Follow for
                    daily food inspiration and recipes.
                  </p>
                </div>
              </span>
            </a>
          ...
          <div class="c-job__video">
            <video
              :src="
                optImg(
                  'https://res.cloudinary.com/dnf1unqkp/video/upload/v1763468509/IMG_0999_z1rb1y.mp4'
                )
              "
              class="hover-reveal__video mobile"
              autoplay
          ...
          <div class="c-job__desc">
            <div class="desc-image">
              <img
                :src="
                  optImg(
                    'https://res.cloudinary.com/dnf1unqkp/image/upload/v1763340447/PHOTO-2025-11-16-20-41-59_ehdnck.jpg'
                  )
                "
            ...
            <div class="desc-text">
              <p>
                Specializing in creating memorable dining experiences with a
                personal touch
              </p>
            </div>
          </div>
...
import { optimizeCloudinaryImage } from '@/utils/index'
